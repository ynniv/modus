...
;;;;
;;;; Produces /tmp/modus64-i386.bin — boot with:
;;;;   qemu-system-i386 -kernel /tmp/modus64-i386.bin -m 256 -nographic
...
(let ((image (build-image :target :i386 :source-text *repl-source*)))
  ...
  (write-kernel-image image "/tmp/modus64-i386.bin")
  (format t "Done. Boot with:~%")
  (format t "  qemu-system-i386 -kernel /tmp/modus64-i386.bin -m 256 -nographic~%"))
